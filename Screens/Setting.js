        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.settingItem}>
                        <View style={styles.settingItemLeft}>
                            <Ionicons name="person-outline" size={24} color="#4bcf47ff" />
                ...
                <View style={styles.section}>
                    ...
                    >
                        <View style={styles.settingItemLeft}>
                            <Ionicons name="language-outline" size={24} color="#4bcf47ff" />
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => Alert.alert(
                            'Developer Details',
                            'Email: deyyabhi2001@gmail.com\nLinkedIn: abhirup-dey-92287725b/\nGitHub: abhi-ingithub22',
                            [{ text: 'OK' }]
                        )}
                    >
                        <View style={styles.settingItemLeft}>
                            <Ionicons name="help-circle-outline" size={24} color="#4bcf47ff" />
                    ...
                    >
                        <View style={styles.settingItemLeft}>
                            <Ionicons name="information-circle-outline" size={24} color="#4bcf47ff" />
