    ...
    return (
        ...
        >
            <ScrollView contentContainerStyle={styles.container}>
                <StatusBar barStyle="light-content" backgroundColor="#4bcf47ff" />
                <LinearGradient
                    colors={['#8af5a1ff', '#4bcf47ff']}
                    style={styles.header}
                >
                ...
                <View style={styles.formContainer}>
                    <Animated.View style={[styles.inputContainer, createAnimatedStyle(formElements[0])]}>
                        <Ionicons name="person-outline" size={20} color="#8af5a1ff" style={styles.inputIcon} />
                        <TextInput
                    ...
                    <Animated.View style={[styles.inputContainer, createAnimatedStyle(formElements[1])]}>
                        <Ionicons name="mail-outline" size={20} color="#8af5a1ff" style={styles.inputIcon} />
                        <TextInput
                    ...
                    <Animated.View style={[styles.inputContainer, createAnimatedStyle(formElements[2])]}>
                        <Ionicons name="lock-closed-outline" size={20} color="#8af5a1ff" style={styles.inputIcon} />
                        <TextInput
...
const styles = StyleSheet.create({
    ...
    signUpButton: {
        backgroundColor: '#4bcf47ff',
        padding: 20,
        borderRadius: 15,
        alignItems: 'center',
        marginTop: 10,
        shadowColor: "#8af5a1ff",
